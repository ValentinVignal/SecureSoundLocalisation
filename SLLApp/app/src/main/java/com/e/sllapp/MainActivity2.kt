...
class MainActivity2 : AppCompatActivity() {
    ...
    private val BufferElements2Rec: Int = 1024 // want to play 2048 (2K) since 2 bytes we use only 1024
    private var BytesPerElement: Int = 2 // 2 bytes in 16bit format
    private var bufferSize: Int= AudioRecord.getMinBufferSize(recorderSampleRate,
        recorderChannels, recorderAudioEncoding)

    private val rootDirectory: File = File(Environment.getExternalStorageDirectory().absolutePath + "/SSL")
